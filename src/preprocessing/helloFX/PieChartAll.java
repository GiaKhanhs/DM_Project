...
public class PieChartAll extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        pieChart.getData().add(new PieChart.Data("None", 76));
        pieChart.getData().add(new PieChart.Data("Mild", 67));
        pieChart.getData().add(new PieChart.Data("Moderate", 73));
        pieChart.getData().add(new PieChart.Data("Moderately Severe", 63));
        pieChart.getData().add(new PieChart.Data("Severe", 42));
        ...
        pieChart.setTitle("Depression Level");
        ...
        primaryStage.setTitle("Depression Level Chart");
